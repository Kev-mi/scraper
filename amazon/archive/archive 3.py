...
class Engine_thread_1():
    def __init__(self, driver_path=r"C:\Users\kevin\.wdm\drivers\chromedriver\win32\104.0.5112.20\chromedriver.exe", teardown=False):
        option = Options()
        option.binary_location = "C:/Program Files/Google/Chrome Beta/Application/chrome.exe"
        self.driver = webdriver.Chrome(service=Service(ChromeDriverManager(version='104.0.5112.20').install()),options=option)
